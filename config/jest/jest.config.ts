...
export default {
    ...
    // cacheDirectory: "C:\\Users\\Ostrovok\\AppData\\Local\\Temp\\jest",
    ...
    /* The maximum amount of workers used to run your tests. Can be specified as
     % or a number. E.g.
    maxWorkers: 10% will use 10% of your CPU amount + 1 as the maximum worker number. maxWorker
    s: 2 will use a maximum of 2 workers. */
    // maxWorkers: "50%",
...
*/
    ...
    */
    ...
    // A list of paths to modules that run some code to config
    // setupFilesAfterEnv: [],
    ...
    // This option sets the URL for the jsdom environme
